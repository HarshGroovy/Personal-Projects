        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 col-12 mt-5 mt-lg-0">
                <div class="about-image-wrap">
                    <img src="<?=Url::base($schema = true)."/images/horizontal-shot-happy-mixed-race-females.jpg"?>" class="about-image about-image-border-radius img-fluid" alt="">
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="owl-carousel owl-theme reviews-carousel">
                    ...
                    <div class="reviews-thumb">
                        ...
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/portrait-beautiful-young-woman-studying-table-with-laptop-computer-notebook-home-studying-online-e-learning-system.jpg"?>" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/university-study-abroad-lifestyle-concept-satisfied-happy-asian-male-student-glasses-shirt-showing-thumbs-up-approval-likes-studying-college-holding-laptop-backpack.jpg"?>" class="avatar-image img-fluid" alt="">

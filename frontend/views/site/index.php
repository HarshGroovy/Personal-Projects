            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-12">
                    <div class="about-image-wrap custom-border-radius-start">
                        <img src="<?= Url::base($schema = true) . "/images/professional-asian-businesswoman-gray-blazer.jpg" ?>"
                    ...
                    <div class="custom-text-block">
                        ...
                        <p class="text-white">Gotto Job is a free website template for job portals. This layout is based
                            on Bootstrap 5 CSS framework. Thank you for visiting <a href="https://www.tooplate.com"
                                target="_parent">Tooplate website</a>."./Images are from <a
                                href="https://www.freepik.com/" target="_blank">FreePik</a> website.</p>
                ...
                <div class="col-lg-3 col-12">
                    <div class="instagram-block">
                        <img src="<?= Url::base($schema = true) . "/images/horizontal-shot-happy-mixed-race-females.jpg" ?>"
        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach ($joblist as $item): ?>
                    <div class="col-lg-12 col-12">
                        <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4 p-5 shadow-sm">
                            <div class="job-image-wrap bg-white ">
                                <img src="<?= Url::base($schema = true) . "/images/logos/google.png" ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <p class="job-date mb-0">
                                        ...
                                        <?= $formattedDate = formatTimeAgo($item->date);?>
                                    </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="video-thumb">
                        <img src="<?= Url::base($schema = true) . "/images/people-working-as-team-company.jpg" ?>"
                            class="about-image custom-border-radius-end img-fluid" alt="">
                        ...
                        <div class="job-thumb job-thumb-box">
                            ...
                            <div class="job-image-box-wrap">
                                <a href="job-details.html">
                                    <img src="<?= Url::base($schema = true) . "/images/jobs/it-professional-works-startup-project.jpg" ?>"
                                        class="job-image img-fluid" alt="">
                                </a>
                            ...
                            <div class="job-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                        <img src="<?= Url::base($schema = true) . "/images/logos/salesforce.png" ?>"
                    ...
                    <div class="owl-carousel owl-theme reviews-carousel">
                        <div class="reviews-thumb">
                            ...
                            <div class="reviews-info d-flex align-items-center">
                                <img src="<?= Url::base($schema = true) . "/images/avatar/portrait-charming-middle-aged-attractive-woman-with-blonde-hair.jpg" ?>"
                            ...
                            <div class="reviews-body">
                                <img src="<?= Url::base($schema = true) . "/images/left-quote.png" ?>"
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img src="<?= Url::base($schema = true) . "/images/avatar/medium-shot-smiley-senior-man.jpg" ?>"
                                    class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            ...
                            <div class="reviews-info d-flex align-items-center">
                                <img src="<?= Url::base($schema = true) . "/images/avatar/portrait-beautiful-young-woman.jpg" ?>"
                                    class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img src="<?= Url::base($schema = true) . "/images/avatar/blond-man-happy-expression.jpg" ?>"
                                    class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-thumb">
                            <div class="reviews-info d-flex align-items-center">
                                <img src="<?= Url::base($schema = true) . "/images/avatar/university-study-abroad-lifestyle-concept.jpg" ?>"
                                    class="avatar-image img-fluid" alt="">

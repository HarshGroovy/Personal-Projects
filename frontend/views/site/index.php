        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-12">
                <div class="about-image-wrap custom-border-radius-start">
                    <img src="<?=Url::base($schema = true)."/images/professional-asian-businesswoman-gray-blazer.jpg"?>" class="about-image custom-border-radius-start img-fluid" alt="">
            ...
            <div class="col-lg-3 col-12">
                <div class="instagram-block">
                    <img src="<?=Url::base($schema = true)."/images/horizontal-shot-happy-mixed-race-females.jpg"?>" class="about-image custom-border-radius-end img-fluid" alt="">
            ...
            <div class="col-lg-12 col-12">
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="<?=Url::base($schema = true)."/images/logos/google.png"?>" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="<?=Url::base($schema = true)."/images/logos/apple.png"?>" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="<?=Url::base($schema = true)."/images/logos/meta.png"?>" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="<?=Url::base($schema = true)."/images/logos/slack.png"?>" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="<?=Url::base($schema = true)."/images/logos/creative-market.png"?>" class="job-image img-fluid" alt="">
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="video-thumb">
                    <img src="<?=Url::base($schema = true)."/images/people-working-as-team-company.jpg"?>" class="about-image custom-border-radius-end img-fluid" alt="">
        ...
        <div class="row align-items-center">
                ...
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/it-professional-works-startup-project.jpg"?>" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/salesforce.png"?>" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/marketing-assistant.jpg"?>" class="job-image img-fluid" alt="marketing assistant">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/spotify.png"?>" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/coding-man.jpg"?>" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/twitter.png"?>" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/pretty-blogger-posing-cozy-apartment.jpg"?>" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/yelp.png"?>" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/paper-analysis.jpg"?>" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/paypal.png"?>" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="<?=Url::base($schema = true)."/images/jobs/logo-designer-working-computer-desktop.jpg"?>" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="<?=Url::base($schema = true)."/images/logos/envato.png"?>" class="job-image me-3 img-fluid" alt="">
                ...
                <div class="owl-carousel owl-theme reviews-carousel">
                    <div class="reviews-thumb">
                        ...
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/portrait-charming-middle-aged-attractive-woman-with-blonde-hair.jpg"?>" class="avatar-image img-fluid" alt="">
                        ...
                        <div class="reviews-body">
                            <img src="<?=Url::base($schema = true)."/images/left-quote.png"?>" class="quote-icon img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/medium-shot-smiley-senior-man.jpg"?>" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        ...
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/portrait-beautiful-young-woman.jpg"?>" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/blond-man-happy-expression.jpg"?>" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-info d-flex align-items-center">
                            <img src="<?=Url::base($schema = true)."/images/avatar/university-study-abroad-lifestyle-concept.jpg"?>" class="avatar-image img-fluid" alt="">
